import {
   header
} from "../base/constSelector";

export const menuBurger = () => {
   const menuNavMain = header.querySelector('.menu__nav');
   const menuBtnMain = header.querySelector('.btn-burger');
   const menuLinkMain = header.querySelectorAll('.menu__link');
   const menuListMain = header.querySelector('.menu__list');

   const menuBodyMain = document.querySelector('body');
   header.addEventListener('click', menuMain);

   function menuMain(event) {
